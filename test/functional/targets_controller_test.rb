...
class TargetsControllerTest < ActionController::TestCase
  ...
  test "should create target" do
    assert_difference('Target.count') do
      post :create, target: { creator_id: @target.creator_id, desc: @target.desc, name: @target.name, status: @target.status }
    end
  ...
  test "should update target" do
    put :update, id: @target, target: { creator_id: @target.creator_id, desc: @target.desc, name: @target.name, status: @target.status }
    assert_redirected_to target_path(assigns(:target))
  end
